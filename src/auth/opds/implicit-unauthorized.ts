...
export const implicitUnauthorizedDoc = (addJson: any = undefined) => {
    const opdsAuthDoc = new OPDSAuthenticationDoc;

    opdsAuthDoc.Id = "";
    opdsAuthDoc.Title = "OAUTH2 implicit authentification";
    ...
    opdsAuth.Type = "http://opds-spec.org/auth/oauth/implicit";
    ...
    authenticateLink.TypeLink = "text/html";
    authenticateLink.Href = resolveSelfUrl("/implicit/login");
